...
# Plot: we are plotting the lowest energy values
# t_prime = 0 means there are not hopping between sites in the chain 
# t stands for the hopping between the quantum dot and the kitaev chain
